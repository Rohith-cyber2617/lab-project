...
export function RegisterPage({ onRegister, onNavigate }: RegisterPageProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const userData = {
      ...
      availability: ['Weekdays 9-5', 'Evenings', 'Weekends']
    };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-900">Join MentorConnect</h2>
          <p className="mt-2 text-gray-600">Create your account and start your mentorship journey</p>
        </div>
